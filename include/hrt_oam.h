...
static inline void hrt_ShowOBJ(u8 spr)
{
	if (spr <= 127)
		OAMBuffer[spr].attr0 &= ~(1 << 9);
}

static inline void hrt_EnableOBJHFlip(u8 spr)
{
	if (spr <= 127)
		OAMBuffer[spr].attr1 |= (1 << 12);
}

static inline void hrt_DisableOBJHFlip(u8 spr)
{
	if (spr <= 127)
		OAMBuffer[spr].attr1 &= ~(1 << 12);
}

static inline void hrt_EnableOBJVFlip(u8 spr)
{
	if (spr <= 127)
		OAMBuffer[spr].attr1 |= (1 << 13);
}

static inline void hrt_DisableOBJVFlip(u8 spr)
{
	if (spr <= 127)
		OAMBuffer[spr].attr1 &= ~(1 << 13);
}

static inline void hrt_ToggleOBJHFlip(u8 spr)
{
	if (spr <= 127)
		OAMBuffer[spr].attr1 ^= 12;
}

static inline void hrt_ToggleOBJVFlip(u8 spr)
{
	if (spr <= 127)
		OAMBuffer[spr].attr1 ^= 13;
}

static inline s16 hrt_GetOBJX(u8 spr)
{
	if (spr <= 127)
...
static inline s16 hrt_GetOBJY(u8 spr)
{
	if (spr <= 127)
...
static inline u16 hrt_GetOBJOffset(u8 spr)
{
	if (spr <= 127)
