...
ASM = hrt_intdispatch.s hrt_syscalls.s hrt_sleep.s hrt_ez4exit.s hrt_rtc.s hrt_rnc2.s
LIBS= libheart.a
CFLAGS = -DHRT_WITH_LIBHEART -DHRT_USE_MBV2LIB -Wall -Os -march=armv4t -Wno-switch -Wno-multichar -ffast-math -mlong-calls -mcpu=arm7tdmi -mtune=arm7tdmi -marm -faggressive-loop-optimizations -mapcs-frame -falign-functions=4
