HEADERS = libheart.h
OBJECTS = build/hrt_oam.o build/hrt_snd.o build/hrt_srm.o build/hrt_swi.o build/hrt_txt.o build/hrt_vid.o build/hrt_gbfs.o build/hrt_start.o build/hrt_logo.o build/hrt_obj.o build/hrt_int.o build/hrt_intdispatch.out build/hrt_font.o build/hrt_font_tile.o build/hrt_syscalls.out build/hrt_misc.o build/hrt_sleep.out build/hrt_ez4exit.out build/hrt_tmr.o build/hrt_pcx.o build/hrt_rng.o maxmod/mm_effect.o maxmod/mm_init_default.o maxmod/mm_main.o maxmod/mm_mas.o maxmod/mm_mas_arm.o maxmod/mm_mixer_gba.o SD/diskio.o SD/ff.o SD/ffsystem.o SD/ffunicode.o
CPPFILES =
SOURCES = hrt_oam.c hrt_snd.c hrt_srm.c hrt_swi.c hrt_txt.c hrt_vid.c hrt_gbfs.c hrt_start.c hrt_logo.c hrt_obj.c hrt_int.c hrt_font.c hrt_font_tile.c hrt_misc.c hrt_tmr.c hrt_pcx.c hrt_rng.c
...
libheart.a: $(OBJECTS)
	...
	cp ff.h C:\devkitPro\devkitARM\lib\gcc\arm-none-eabi\7.1.0\include
	cp ffconf.h C:\devkitPro\devkitARM\lib\gcc\arm-none-eabi\7.1.0\include
	cp diskio.h C:\devkitPro\devkitARM\lib\gcc\arm-none-eabi\7.1.0\include
	cp integer.h C:\devkitPro\devkitARM\lib\gcc\arm-none-eabi\7.1.0\include
